...
<body>
<form name="formularz" action="registercheck.php" onsubmit="return validateForm()" method="POST">
        <div class="container">
            <hr>
            ...
            <button type="submit" class="register">Zarejestruj</button>
            <hr>
        </div>

        <div class="container signin">
            <p>Powrót do strony <a href="login.php">logowania</a>.</p>
        </div>
    </form>
